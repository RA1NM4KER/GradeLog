      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-2.5 sm:gap-6 sm:px-8 sm:py-3.5">
        ...
        <div className="flex min-w-0 flex-1 items-center justify-end">
          <nav className="flex items-center gap-1 sm:gap-2">
            ...
            <Link
              className="px-1 mr-2 text-sm font-medium text-ink-strong transition hover:text-foreground sm:mr-0 sm:rounded-[10px] sm:bg-white/10 sm:px-4 sm:py-2 sm:text-[13px] sm:backdrop-blur-sm dark:sm:bg-white/10"
              href="/"
              prefetch={false}
            >
              Semesters
